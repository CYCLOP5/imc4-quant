...
class Trader:
    LIMITS = {'EMERALDS': 80, 'TOMATOES': 80, 'INTARIAN_PEPPER_ROOT': 80, 'ASH_COATED_OSMIUM': 80, 'RAINFOREST_RESIN': 50, 'KELP': 50, 'SQUID_INK': 50, 'CROISSANTS': 250, 'JAMS': 350, 'DJEMBES': 60, 'PICNIC_BASKET1': 60, 'PICNIC_BASKET2': 100, 'VOLCANIC_ROCK': 400, 'VOLCANIC_ROCK_VOUCHER_9500': 200, 'VOLCANIC_ROCK_VOUCHER_9750': 200, 'VOLCANIC_ROCK_VOUCHER_10000': 200, 'VOLCANIC_ROCK_VOUCHER_10250': 200, 'VOLCANIC_ROCK_VOUCHER_10500': 200, 'MAGNIFICENT_MACARONS': 75, 'HYDROGEL_PACK': 200, 'VELVETFRUIT_EXTRACT': 200, 'VEV_4000': 300, 'VEV_4500': 300, 'VEV_5000': 300, 'VEV_5100': 300, 'VEV_5200': 300, 'VEV_5300': 300, 'VEV_5400': 300, 'VEV_5500': 300, 'VEV_6000': 300, 'VEV_6500': 300}
    ROUND5_PREFIXES = ('GALAXY_SOUNDS_', 'SLEEP_POD_', 'MICROCHIP_', 'PEBBLES_', 'ROBOT_', 'UV_VISOR_', 'TRANSLATOR_', 'PANEL_', 'OXYGEN_SHAKE_', 'SNACKPACK_')
    ROUND5_LIMIT = 10
    DEFAULT_LIMIT = 100
    TEST_SIZE = 1
    ...
    def run(self, state: TradingState):
        ...
        for product, order_depth in state.order_depths.items():
            ...
            orders_by_product[product] = self.cross_visible_book(product, order_depth, position, limit)
    ...
    def cross_visible_book(self, product: str, order_depth: OrderDepth, position: int, limit: int) -> List[Order]:
        orders: List[Order] = []
