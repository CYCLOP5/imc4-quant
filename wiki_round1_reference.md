i keep this file as an offline copy of the public r1 brief for grep; the prose below is imc’s wording, not my notes.
...
At the end of every round - before the timer runs out - all teams will have to submit their algorithmic and manual trades to be processed. The algorithms will then participate in a full day of trading against the Prosperity trading bots.
When Round 5 ends, the final results will be processed and the winner of the Prosperity trading challenge will be announced within 2 weeks.

## Algorithmic & Manual trading
Every round contains both algorithmic and manual trading challenges. Submissions lock when the round timer ends. Only the active explicitly submitted scripts and trades execute. Manual trades have no effect on your algorithmic trade and can be seen as separate challenges to gain additional profits.

Stolen from :wiki(https://imc-prosperity.notion.site/prosperity-4-wiki)