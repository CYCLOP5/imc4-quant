...
class BackTester:
    ...
    def __run_test(self, trader_module, data_reader: BackDataReader, round: int, day: int) -> BacktestResult:
        ...
        test_runner = TestRunner(trader_module.Trader(), data_reader, round, day, self.options.show_progress, self.options.print_output, self.options.trade_matching_mode)
