...
class TestRunner:
    ...
    def run(self):
        ...
        state = TradingState(traderData='', timestamp=0, listings={}, order_depths={}, own_trades={}, market_trades={}, position={}, observations=Observation({}, {}))
    ...
    def __initialize_trade_state(self, state: TradingState, data: BacktestData, timestamp: int) -> TradingState:
        ...
        if observation_row is None:
            ...
            conversion_observation = ConversionObservation(bidPrice=observation_row.bidPrice, askPrice=observation_row.askPrice, transportFees=observation_row.transportFees, exportTariff=observation_row.exportTariff, importTariff=observation_row.importTariff, sugarPrice=observation_row.sugarPrice, sunlightIndex=observation_row.sunlightIndex)
            state.observations = Observation(plainValueObservations={}, conversionObservations={'MAGNIFICENT_MACARONS': conversion_observation})
        return state
