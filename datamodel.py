...
class Observation:
    def __init__(self, plainValueObservations: Dict[Product, ObservationValue] = None, conversionObservations: Dict[Product, ConversionObservation] = None) -> None:
        self.plainValueObservations = plainValueObservations if plainValueObservations else {}
        self.conversionObservations = conversionObservations if conversionObservations else {}
